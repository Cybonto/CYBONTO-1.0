...
datasets : [
{
label: 'Knowledge (Ontololgy-Import)',
...
var context = document.getElementById('All Measures by Category-Ontololgy-Import--Knowledge-overall-top-ranked-barchart').getContext("2d");
